...
import { Core, GetChildObjectsRequest, GetChildObjectsResponse, GetFeatureFlagsRequest, GetFeatureFlagsResponse, GetFluxNamespaceRequest, GetFluxNamespaceResponse, GetInventoryRequest, GetInventoryResponse, GetObjectRequest, GetObjectResponse, GetPolicyRequest, GetPolicyResponse, GetPolicyValidationRequest, GetPolicyValidationResponse, GetReconciledObjectsRequest, GetReconciledObjectsResponse, GetSessionLogsRequest, GetSessionLogsResponse, GetVersionRequest, GetVersionResponse, IsCRDAvailableRequest, IsCRDAvailableResponse, ListEventsRequest, ListEventsResponse, ListFluxCrdsRequest, ListFluxCrdsResponse, ListFluxRuntimeObjectsRequest, ListFluxRuntimeObjectsResponse, ListNamespacesRequest, ListNamespacesResponse, ListObjectsRequest, ListObjectsResponse, ListPoliciesRequest, ListPoliciesResponse, ListPolicyValidationsRequest, ListPolicyValidationsResponse, ListRuntimeCrdsRequest, ListRuntimeCrdsResponse, ListRuntimeObjectsRequest, ListRuntimeObjectsResponse, SyncFluxObjectRequest, SyncFluxObjectResponse, ToggleSuspendResourceRequest, ToggleSuspendResourceResponse } from "../api/core/core.pb";
...
describe("graph lib", () => {
  ...
  beforeEach(() => {
    client = createCoreMockClient({
      ...
      GetChildObjects: (req): GetChildObjectsResponse => {
  ...
  describe("deterministic graph", () => {
    ...
    it("returns children in the same order every time", async () => {
      ...
      const newClient = {
        ...client,
        GetChildObjects: async (req: GetChildObjectsRequest) => {
