...
import { colors, fontSizes } from "../typedefs/styled.d";
...
export const muiTheme = (themeColors: typeof colors, mode: ThemeTypes) =>
  createTheme({
    typography: { fontFamily: "proxima-nova" },
    palette: {
      primary: {
        //Main - Primary Color Dark - 10
        main: themeColors.primary10,
      },
      secondary: {
        //Feedback - Alert - Original
        main: themeColors.alertOriginal,
      },
      text: {
        //Neutral - Neutral - 40
        primary: themeColors.neutral40,
        //Neutral - Neutral - 30
        secondary: themeColors.neutral30,
        disabled: themeColors.neutral30,
      },
    },
    components: {
      MuiSlider: {
      ...
      MuiButton: {
        styleOverrides: {
          root: {
            '&.Mui-disabled': {
              color: ThemeTypes.Dark ? themeColors.primary30 : themeColors.neutral20,
            },
          },
          outlined: {
            '&.Mui-disabled': {
          ...
          outlinedPrimary: {
            '&.Mui-disabled': {
              color: mode === ThemeTypes.Dark ? themeColors.primary30 : themeColors.neutral20,
              borderColor:
                mode === ThemeTypes.Dark
                  ? `${themeColors.primary30}`
                  : `${themeColors.neutral20}`,
      ...
      MuiCheckbox: {
        styleOverrides: {
          colorSecondary: {
            "&.Mui-disabled": {
              color: mode === ThemeTypes.Dark && themeColors.neutral40,
            },
          },
        },
      },
      MuiInput: {
        styleOverrides: {
          underline: {
            "&::before": {
              borderBottom:
                mode === ThemeTypes.Dark && `1px solid ${themeColors.neutral40}`,
            },
          },
        },
      },
      ...
      MuiRadio: {
        styleOverrides: {
          ...
          colorSecondary: {
            ...
            "&:hover": {
              backgroundColor: ThemeTypes.Dark
                ? alpha(themeColors.primary10, 0.2)
          ...
          colorPrimary: {
            ...
            "&.Mui-disabled": {
              color:
                mode === ThemeTypes.Dark ? themeColors.primary30 : themeColors.neutral20,
            },
          },
        },
      },
