...
describe("DataTable", () => {
  ...
  const fields = [
    {
      label: "Name",
      value: ({ name }: { name: string }) => <a href="/some_url">{name}</a>,
    ...
    },
    {
      label: "Status",
      value: "status",
      sortValue: ({ status, suspended }: { status: boolean | string, suspended: boolean }) => {
    ...
    },
    {
      label: "Last Updated",
      value: "lastUpdate",
      sortValue: ({ lastUpdate }: { lastUpdate: string }) => lastUpdate,
    },
    {
      label: "Last Synced At",
      value: "lastSyncedAt",
      sortValue: ({ lastSyncedAt }: { lastSyncedAt: number }) => lastSyncedAt,
    },
  ];
