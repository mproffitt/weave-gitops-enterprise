...
function getIcon(i: IconType) {
  switch (i) {
    ...
    case IconType.FailedIcon:
      ...
      return () => <img src={images.failedSrc} alt="failed" />;
    ...
    case IconType.PendingActionIcon:
      // eslint-disable-next-line react/display-name
      return () => <img src={images.pendingAction} alt="pending" />;
    ...
    case IconType.ReconcileIcon:
      // eslint-disable-next-line react/display-name
      return () => <img src={images.reconcileSrc} alt="reconciling" />;
    ...
    case IconType.SuccessIcon:
      // eslint-disable-next-line react/display-name
      return () => <img src={images.successSrc} alt="success" />;

    case IconType.SuspendedIcon:
      // eslint-disable-next-line react/display-name
      return () => <img src={images.suspendedSrc} alt="suspended" />;
...
function Icon({ className, type, text, color, fontSize }: Props) {
  return (
    <Flex align className={className}>
      ...
      {text && (
        <Text color={color as keyof typeof colors} bold size={fontSize}>
          {text}
        </Text>
      )}
    </Flex>
...
export default styled(Icon)`
  svg {
    fill: ${(props) => props.theme.colors[props.color as keyof typeof props.theme.colors]};
    height: ${(props) => props.theme.spacing[props.size as keyof typeof props.theme.spacing]};
    width: ${(props) => props.theme.spacing[props.size as keyof typeof props.theme.spacing]};
    path,
    line,
    polygon,
    rect,
    ...
    polyline {
      &.path-fill {
        fill: ${(props) => props.theme.colors[props.color as keyof typeof props.theme.colors]} !important;
        transition: fill 200ms cubic-bezier(0.4, 0, 0.2, 1) 0ms;
      }
      &.stroke-fill {
        stroke: ${(props) => props.theme.colors[props.color as keyof typeof props.theme.colors]} !important;
  ...
  ${Text} {
    ...
    font-size: ${(props) => props.theme.fontSizes[props.fontSize as keyof typeof props.theme.fontSizes]};
  }
