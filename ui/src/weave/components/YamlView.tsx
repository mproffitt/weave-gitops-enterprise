...
function UnstyledYamlView({
  ...
  const dark = theme ? theme === ThemeTypes.Dark : inDarkMode;
  ...
  const styleProps = {
    ...
    codeTagProps: {
      style: {
        wordBreak: "break-word" as Property.WordBreak,
      },
    },

    lineProps: {
      style: {
        textWrap: "wrap" as Property.TextWrap,
      }
    },

    ...(dark && { style: a11yDark } || { style: a11yLight }),
  };
